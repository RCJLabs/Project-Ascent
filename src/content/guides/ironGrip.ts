      ...
      content: [
        ...
        { kind: 'h', text: 'Week by Week' },
        {
          ...
          rows: [
            ...
            [ '4 (Deload)', 'The Anvil', 'One Finger Protocol day this week instead of two. 7/3 Repeaters at 2 sets, same edge and the same added weight. Armor stays. Climb, but nothing at your limit.'],
            ...
            [ '8 (Deload)', 'The Hammer', 'One Finger Protocol day. Max Hangs at 3 sets of 10 seconds, same percentage — the load is the thing you keep. No limit bouldering.'],

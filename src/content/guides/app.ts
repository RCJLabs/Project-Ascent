      ...
      content: [
        ...
        { kind: 'h', text: 'How a block progresses' },
        {
          ...
          items: [
            ...
            '**Your check-in can suggest less of it.** Answer the two questions before a session and the app puts a lighter dose beside each line, with the answers that produced it. It is a suggestion and stays one — the program\'s numbers do not move, and taking it is your call.',
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            '**A partner’s name is the one thing in your log that is about somebody else.** It rides the backup and the spreadsheet, because those are your own data going to your own disk and a backup that dropped it would lose history. It is never on a share card — that is a picture made to be posted, and the person named never installed this app.',
      ...
      content: [
        ...
        },
        {
          ...
          items: [
            ...
            '**A name you wrote down is not yours to post.** Partners go in your backup and your spreadsheet and never onto a share card.',

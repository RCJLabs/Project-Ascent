      ...
      content: [
        ...
        { kind: 'h', text: 'Week by Week' },
        {
          ...
          rows: [
            ...
            [ '4 (Deload)', 'Stability', 'Cut the sets by a third to a half. Keep the load — a deload is less volume, not lighter work.'],
            ...
            [ '8 (Deload)', 'Intensification', 'Cut the sets by a third to a half. Keep the load.'],

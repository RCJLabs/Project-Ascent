  ...
  sections: [
    ...
    },
    {
      ...
      content: [
        ...
        {
          kind: 'table',
          head: ['Week', 'Phase', 'Focus'],
          rows: [
            [ '1', 'Stability', 'Lock-offs, slow tempos, controlled negatives. Hold more, for longer, without shaking.'],
            [ '2', 'Stability', 'Same. Build isometric endurance in climbing positions.'],
            [ '3', 'Stability', 'Same. Groove the pattern before you load it.'],
            [ '4 (Deload)', 'Stability', 'Session A once this week instead of twice. Density Hangs at 3 sets, the same 30 seconds on the same edge; Lock-Off and Pull at 2 sets. Armor stays. Session B and the technique day run as written.'],
            [ '5', 'Intensification', 'Heavier hangs, weighted lock-offs, harder static boulders. Expect to feel slow at first.'],
            [ '6', 'Intensification', 'Same. Recovery between Session A efforts matters more than ever.'],
            [ '7', 'Intensification', 'Same. Scapular stability under the heaviest loads of the block.'],
            [ '8 (Deload)', 'Intensification', 'Session A once. Density Hangs at 3 sets holding week 7’s time and load — progress neither this week. Lock-Off and Pull at 2 sets. Armor stays.'],
            [ '9', 'Integration', 'Static strength on the wall: limit statics, perfect footwork under max effort.'],
            [ '10', 'Integration', 'Same. Project the static-intensive boulders.'],
            [ '11', 'Integration', 'Same. Max hangboard protocol tests.'],
            [ '12', 'Integration', 'Graduation benchmarks — measure what you built.'],
          ],
        },
        {
          kind: 'warn',
      ...
      content: [
        {
          ...
          items: [
            ...
            'Hanging Windshield Wipers: 3×8 per side. Rotate slowly.',
